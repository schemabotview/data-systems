...
import { encodingScenes } from './encoding'
import { replicationScenes } from './replication'
import { partitioningScenes } from './partitioning'
import { transactionsScenes } from './transactions'
...
const ALL: Scene[] = [...modelsScenes, ...storageScenes, ...encodingScenes, ...replicationScenes, ...partitioningScenes, ...transactionsScenes, ...faultsScenes, ...consistencyScenes]
